...
function buildRenderData(process: any) {
  ...
  return {
    ...
    EMPRESARIO_RG: fd.rg ?? '',
    EMPRESARIO_RG_ORGAO: fd.rg_orgao ?? '',
    EMPRESARIO_RG_UF: 'SP',
    EMPRESARIO_NACIONALIDADE: 'brasileiro(a)',
    EMPRESARIO_ESTADO_CIVIL: fd.estado_civil ?? '',
    EMPRESARIO_REGIME_BENS: fd.regime_bens ?? '',
    EMPRESARIO_PROFISSAO: fd.profissao ?? '',
    EMPRESARIO_NASCIMENTO: fd.nascimento ?? '',
